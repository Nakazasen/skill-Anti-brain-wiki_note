...
> "Một câu trả lời có trích dẫn nguồn vẫn tốt hơn là một câu đoán mò chắp vá tự tin."
> 
...
- `AGENTS.md`: Tóm lược kiến trúc hệ thống và các bất biến (invariants) bắt buộc phải có.
